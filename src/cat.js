/* eslint-disable */
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2022-10-11T12:35:15.233Z; */
 ...
 * Metric Type: MAQL Metric
 */
export const Link = newMeasure(idRef("link", "measure"));
/**
 ...
 * Metric Type: MAQL Metric
 */
export const PercentRevenueFromTop10Customers = newMeasure(idRef("percent_revenue_from_top_10_customers", "measure"));
/**
 * Metric Title: % Revenue from Top 10% Customers
 * Metric ID: percent_revenue_from_top_10_percent_customers
 * Metric Type: MAQL Metric
 */
export const PercentRevenueFromTop10PercentCustomers = newMeasure(idRef("percent_revenue_from_top_10_percent_customers", "measure"));
/**
 * Metric Title: % Revenue from Top 10% Products
 * Metric ID: percent_revenue_from_top_10_percent_products
 * Metric Type: MAQL Metric
 */
export const PercentRevenueFromTop10PercentProducts = newMeasure(idRef("percent_revenue_from_top_10_percent_products", "measure"));
/**
 * Metric Title: % Revenue from Top 10 Products
 * Metric ID: percent_revenue_from_top_10_products
 * Metric Type: MAQL Metric
 */
export const PercentRevenueFromTop10Products = newMeasure(idRef("percent_revenue_from_top_10_products", "measure"));
/**
...
export const Insights = {
   ...
   * Insight ID: 9de1524d-7abb-4100-a1bd-f1f51b629195
   */,
  BigTable: "9de1524d-7abb-4100-a1bd-f1f51b629195"
  /**
   * Insight Title: Big table - bar chart view
   * Insight ID: e48e3f07-8d2b-4e4f-a4fd-0dc652e36c06
   */,
  BigTableBarChartView: "e48e3f07-8d2b-4e4f-a4fd-0dc652e36c06"
};
